...
const Login = () => {
    ...
    return (
        <div className="lg:grid lg:grid-cols-5 flex flex-col-reverse ">
            ...
            <div className=" col-span-2 top-32 right-5 p-8 space-y-3 bg-rose-100 dark:text-black">
                ...
                <form onSubmit={handleSignIn} action="" className="space-y-6">
                    ...
                    <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-end text-xs dark:text-gray-700">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm dark:text-gray-900 bg-[#E527B2]">Sign in</button>
                </form>
                <div className="flex items-center pt-4 space-x-1">
                    <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
                    <p className="px-3 text-sm dark:text-gray-700">Login with social accounts</p>
                    <div className="flex-1 h-px sm:w-16 dark:bg-gray-700"></div>
                </div>
                ...
                <p className="text-xs text-center sm:px-6 dark:text-gray-700">Do not have an account?
                    <Link to='/register' rel="noopener noreferrer" className="hover:underline text-md pl-2 font-semibold dark:text-gray-700">Sign up</Link>
                </p>
            </div>
        </div>
    );
